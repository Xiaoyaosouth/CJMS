...
<html>
	...
	<body>
	  <input type="button" value="返回" class="btn btn-default" 
  		     onclick="window.location.href='<%=basePath%>adminSearchGrade?id=${gradePojo.grade_course }&type=cour'"/>
	  <form action="adminUpdateStuGrade?backPage=cour" method="post" role="form">
